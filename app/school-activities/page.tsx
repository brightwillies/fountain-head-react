    ...
    <SidebarLinks
      ...
      links={[
        ...
        { label: "Pre-School", href: "/pre-school-curriculum" },
        {
          ...
          href: "/lower-upper-school-curriculum",
        },
...
const clubs = [
  { name: "Light Of The World", image: "images/concert_img.jpg" },
  { name: "6th March Pass", image: "images/cadet_club.jpg" },
  { name: "Career Day", image: "images/literacy_club.jpg" },
  { name: "AU Day", image: "images/bible_club.jpg" },
];
...
export default function AdmissionPage() {
  return (
    <PageLayout
      ...
      breadcrumbs={[{ label: "School Activities" }]}
      sidebar={sidebar}
    >
      <SectionHeader
        ...
        title={
          <>
            Discover Our School Activities
            <br />
      ...
      <Prose>
        <p>
          FCS is known best for its vibrancy in sports. It has an enthusiastic
          sports team who always go for competitions and bring glory to the
          school.
        </p>
      </Prose>

      <img src="images/openday_pic.jpg" alt="" />
      <br />
