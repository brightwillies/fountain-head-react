...
const clubs = [
  { name: "Drama Club", image: "images/drama_club.jpg" },
  { name: "Cadet", image: "images/cadet_club.jpg" },
  { name: "Literacy Club", image: "images/literacy_club.jpg" },
  { name: "Bible Club", image: "images/bible_club.jpg" },
  { name: "Red Cross Club", image: "images/red_cross_club.jpg" },
  { name: "Science & Math Club", image: "images/science_math_club.jpg" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          {clubs.map((club, index) => (
            ...
            >
              ...
              />
              {/* Gradient overlay */}
              <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.80) 0%, rgba(0,0,0,0.15) 50%, transparent 100%)' }} />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 text-center">
                ...
                <div
                  ...
                  style={{ background: '#c9a84c', width: '2.5rem' }}
                />
              </div>
            </div>
          ))}
